  ...
  const nextPageHandler = async () => {
    if (!selectedBook)
      snackbarCtx.addMessage({
        title: 'Please select a book which you want to upload',
        status: 'warning',
      })
    else if (!selectedBookType || !selectedFileType)
      snackbarCtx.addMessage({
        title: 'Please select book file which you want to upload',
        status: 'warning',
      })
    else {
      toggleSpinner(true)
  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta
          name='description'
          content='Select book which user wants to upload'
        />
      </Head>
          ...
          <div className='p-4 xl:p-8 w-full sm:w-3/5 md:w-1/2 lg:w-2/5 xl:w-[36%]'>
            {selectedBook && !(addBookModal || showSearchModal) ? (
              ...
              <Fragment>
                ...
                <p className='text-xl font-medium text-center py-2'>
                ...
                <p className='text-xl text-center font-medium pb-2'>
                ...
                >
                  <p className='font-medium px-3 py-2 xl:px-3.5 xl:py-2.5'>
                    Add New Book
                  </p>
            ...
            <BookUploadModal
              ...
              saveBookHandler={() => {
                if (selectedBook) {
                  ...
                  snackbarCtx.addMessage({
                    title: 'Please search and select a book',
                    status: 'fail',
                  })
              }}
            >

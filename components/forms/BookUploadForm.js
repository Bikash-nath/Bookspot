  ...
  const genreAddHandler = () => {
    if (inputGenre?.length > 2) {
      ...
      snackbarCtx.addMessage({
        title: 'Please enter a valid genre',
        status: 'fail',
      })
  }
            ...
            <div className='flex flex-col items-center justify-center pb-1'>
              {image ? (
                <img
                  src={image}
                  alt='Selected'
                  className='mb-2 rounded-lg max-w-full max-h-48'
                />
              ) : (
                <>
                  <ImageIcon />
              ...
              <div className='flex text-sm leading-6 text-gray-400'>
                ...
                <p className='text-sm leading-5 text-gray-400 pl-1'>
                  or drag and drop
                </p>
              </div>
        ...
        <div className='col-span-6'>
          ...
          <div className='mt-1.5 flex justify-center w-2/3 rounded-lg border border-dashed border-gray-600 py-4'>
            <div className='flex flex-col items-center justify-center pb-1'>
              {image ? (
                <img
                  src={URL.createObjectURL(image)} // Display selected image preview
                  alt='Selected'
                  className='mb-2 rounded-lg max-w-full max-h-48'
                />
              ) : (
        ...
        <div className='col-span-4'>
          ...
          <div className='flex flex-wrap items-center justify-start gap-x-4'>
            {genreList?.map((genre, i) => (
              <div
                className='flex rounded-full bg-[#334366] text-white my-2'
                key={i}
              >
